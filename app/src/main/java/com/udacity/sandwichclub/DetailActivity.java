...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView ingredientsTv , originTv , descriptionTv , knownAsTv ;
    ...
    private void populateUI(Sandwich sandwich) {
        if (sandwich.getIngredients().size()!=0 && sandwich.getIngredients()!=null) {
            ...
            ingredientsTv.setText(getString(R.string.no_ingredients));
        }
        ...
        if (sandwich.getAlsoKnownAs().size()!=0 && sandwich.getAlsoKnownAs()!=null) {
            ...
            knownAsTv.setText(getString(R.string.also_known));
        }
